/**
 * The sidebar remote-control seat: the phone-icon trigger beside the settings
 * button and the pairing panel modal. Owns the panel behavior — token minting
 * on open, the status SSE subscription, stop/refresh/copy — and renders the
 * pure {@link RemotePanel} body. Component-local state per the client
